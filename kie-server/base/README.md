...
More information of KIE Server available at [JBoss documentation](https://docs.jboss.org/drools/release/7.37.0.Final/drools-docs/html_single/#_ch.kie.server).
