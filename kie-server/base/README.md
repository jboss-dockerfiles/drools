...
More information of KIE Server available at [JBoss documentation](https://docs.jboss.org/drools/release/7.0.0.Final/drools-docs/html_single/#_ch.kie.server).
...
* Upgrade app to version `7.0.0.Final`         
