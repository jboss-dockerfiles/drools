...
More information of KIE Server available at [JBoss documentation](http://docs.jboss.org/drools/release/7.5.0.Final/drools-docs/html_single/#_ch.kie.server).
...
* JBoss Drools KIE Server 7.5.0.Final
...
For more information, please read the documentation at [Installing the KIE Server](http://docs.jboss.org/drools/release/7.5.0.Final/drools-docs/html_single/#_installing_the_kie_server).
...
* Drools KIE Server version is `7.5.0.Final`
...
* See release notes for [KIE-server](https://docs.jboss.org/drools/release/7.5.0.Final/drools-docs/html_single/index.html#_ch.kie.server)
