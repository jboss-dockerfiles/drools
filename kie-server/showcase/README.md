...
More information of KIE Server available at [JBoss documentation](http://docs.jboss.org/drools/release/7.6.0.Final/drools-docs/html_single/#_ch.kie.server).
...
For more information, please read the documentation at [Installing the KIE Server](http://docs.jboss.org/drools/release/7.6.0.Final/drools-docs/html_single/#_installing_the_kie_server).
