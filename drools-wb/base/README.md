...
* Drools Workbench version is `7.18.0.Final`
...
**7.18.0.Final**
* See release notes for [Drools](https://docs.jboss.org/drools/release/7.18.0.Final/drools-docs/html_single/#_droolsreleasenoteschapter)
