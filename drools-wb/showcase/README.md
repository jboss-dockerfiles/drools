...
* JBoss Drools Workbench 7.1.0.Final
...
* Drools Workbench version is `7.1.0.Final`
...
* See release notes for [Drools Workbench](https://hub.docker.com/r/jboss/drools-workbench/) version `7.1.0.Final`                     
